...
/**
 * Компонент нижней панели навигации (BottomNavigationBar).
 *
 * Отображает иконки и подписи для основных экранов приложения.
 * Позволяет пользователю перемещаться между разделами, используя `NavController`.
 *
